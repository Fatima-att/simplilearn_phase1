...
public class presentation {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------------------------------------ ");
		System.out.println(" Developer: FATIMA NASER ATTOUN ");
		System.out.println("------------------------------------------------------------------------ ");
		...
		do {
			...
			System.out.println("-----------------------------------------------------");
			System.out.println("1. present all files in Ascending order");
		...
		try {
			ch = Integer.parseInt(sc.nextLine());// to read the value user enter it
